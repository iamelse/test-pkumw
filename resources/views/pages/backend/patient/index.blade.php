...
@section('content')
<div x-data="{ isFilterModal: false }" class="p-4 mx-auto w-full md:p-6 space-y-10">
    {{-- Page Header --}}
    ...
    >
        ...
        {{-- Modal Content --}}
        <div 
            @click.outside="isFilterModal = false" 
            x-transition
